...
const priceCategories = [
  {
    ...
    services: [
      { name: "Быстрое восстановление", price: "14 000 р.", duration: "45-60 мин", popular: true },
      { name: "Восстановление на дому", price: "18 000 р.", duration: "60-90 мин" },
      { name: "Против утомления", price: "8 000 р.", duration: "30-45 мин" },
      { name: "Против похмелья", price: "9 000 р.", duration: "45 мин" },
      { name: "Энерджайзер", price: "8 000 р.", duration: "45 мин" },
      { name: "Выносливость к нагрузкам", price: "11 000 р.", duration: "60 мин" },
    ],
  },
  {
    category: "Капельницы для красоты",
    services: [
      { name: "Золушка", price: "9 000 р.", duration: "60 мин", popular: true },
      { name: "Уход за кожей", price: "10 000 р.", duration: "60 мин" },
      { name: "Уход за волосами", price: "10 000 р.", duration: "60 мин" },
      { name: "Барби-капельница", price: "10 000 р.", duration: "60 мин" },
      { name: "Бархатная кожа", price: "7 000 р.", duration: "45 мин" },
      { name: "Глутатион", price: "8 000 р.", duration: "45 мин" },
      { name: "Лаеннек", price: "14 200 р.", duration: "60 мин" },
    ],
  },
  {
    category: "Капельницы для здоровья",
    services: [
      { name: "Против аллергии", price: "9 000 р.", duration: "45 мин" },
      { name: "Укрепление иммунитета", price: "9 000 р.", duration: "60 мин" },
      { name: "Против стресса", price: "8 000 р.", duration: "45 мин" },
      { name: "Против герпеса", price: "10 000 р.", duration: "45 мин" },
      { name: "Против простуды", price: "10 000 р.", duration: "45 мин" },
      { name: "Стоп мигрень", price: "9 000 р.", duration: "30 мин" },
      { name: "Активность мозга", price: "8 000 р.", duration: "45 мин" },
    ],
  },
  {
    category: "Лечебные капельницы",
    services: [
      { name: "Детокс", price: "10 500 р.", duration: "60 мин", popular: true },
      { name: "При железодефиците", price: "8 000 р.", duration: "60 мин" },
      { name: "Восполнение белка", price: "8 000 р.", duration: "45 мин" },
      { name: "Для похудения", price: "6 000 р.", duration: "45 мин" },
      { name: "Ускорение метаболизма", price: "10 500 р.", duration: "60 мин" },
      { name: "Против отёков", price: "10 000 р.", duration: "45 мин" },
    ],
  },
  {
